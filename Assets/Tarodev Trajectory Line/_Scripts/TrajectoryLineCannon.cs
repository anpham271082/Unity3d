...
public class TrajectoryLineCannon : MonoBehaviour {
    [SerializeField] private TrajectoryLineProjection _projection;
    ...
    [SerializeField] private TrajectoryLineBall _ballPrefab;
